    ...
    <div className="min-h-screen pt-20">
      <div className="container mx-auto px-6 py-16">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-2xl font-serif text-black mb-8 italic">
          ...
          <div className="bg-white/90 p-8 rounded-lg backdrop-blur-sm">
            ...
            <div className="space-y-4">
              <div className="border-l-2 border-gd-red pl-4">
                <h4 className="font-medium text-black">1. Escucha Activa</h4>
                <p className="text-sm text-black">Entendemos tus necesidades y sueños</p>
              </div>
              <div className="border-l-2 border-gd-blue pl-4">
                <h4 className="font-medium text-black">2. Diseño Colaborativo</h4>
                <p className="text-sm text-black">Desarrollamos propuestas juntos</p>
              </div>
              <div className="border-l-2 border-gd-gray pl-4">
                <h4 className="font-medium text-black">3. Acompañamiento Total</h4>
                <p className="text-sm text-black">Te guiamos hasta la entrega final</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="text-center mb-16">
          <h2 className="font-serif text-3xl text-black mb-8">Nuestro Equipo</h2>
          <div className="bg-white/90 p-8 rounded-lg backdrop-blur-sm max-w-3xl mx-auto">
            <h3 className="font-serif text-2xl text-black mb-4">García Delillo</h3>
            <p className="text-black leading-relaxed mb-4">
        ...
        {/* Servicios */}
        <div className="bg-white/90 p-8 rounded-lg backdrop-blur-sm">
          <h2 className="font-serif text-3xl text-black mb-8 text-center">Servicios</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="text-center">
              ...
              <h4 className="font-medium text-black mb-2">Diseño Arquitectónico</h4>
              <p className="text-sm text-black">Proyectos residenciales y comerciales</p>
            </div>
            <div className="text-center">
              ...
              <h4 className="font-medium text-black mb-2">Planificación</h4>
              <p className="text-sm text-black">Estudios de factibilidad y zonificación</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 mx-auto mb-4 bg-gd-gray/10 rounded-full flex items-center justify-center">
                <span className="text-2xl text-black">🔨</span>
              </div>
              <h4 className="font-medium text-black mb-2">Construcción</h4>
              <p className="text-sm text-black">Dirección y supervisión de obra</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 mx-auto mb-4 bg-green-500/10 rounded-full flex items-center justify-center">
                <span className="text-2xl text-green-600">🌱</span>
              </div>
              <h4 className="font-medium text-black mb-2">Sustentabilidad</h4>
              <p className="text-sm text-black">Certificaciones y eficiencia energética</p>
            </div>
          </div>
        </div>
      </div>
