...
export default function GDLogo({ 
  className = '', 
  width = 210, 
  height = 170, 
  autoPlay = true 
  ...
  // Si no hay autoPlay, mostrar logo estático
  if (!autoPlay) {
    return (
      <div className={className}>
        ...
        >
          ...
          <line 
            ...
            fill="none"
          />
          <line className="stroke-black stroke-1" x1="22.3182" y1="51.9211" x2="185.0042" y2="51.9211" strokeLinecap="round" strokeLinejoin="round" fill="none" />
          <line className="stroke-black stroke-1" x1="173.3234" y1="36.2735" x2="173.778" y2="134.9636" strokeLinecap="round" strokeLinejoin="round" fill="none" />
          <line className="stroke-black stroke-1" x1="185.0042" y1="118.5687" x2="22.3182" y2="118.5687" strokeLinecap="round" strokeLinejoin="round" fill="none" />
          <line className="stroke-black stroke-1" x1="40.4825" y1="30.2342" x2="40.4825" y2="137.8011" strokeLinecap="round" strokeLinejoin="round" fill="none" />
          
          <path 
            className="stroke-gd-gray"
            strokeWidth="0.75"
            strokeLinecap="round"
            strokeLinejoin="round"
            fill="none"
  ...
  return (
    <div className={`${className}`}>
      {/* Solo SVG Logo Animado - Sin texto */}
      <motion.svg
        viewBox="0 0 210 170"
        width={width}
        height={height}
      ...
      >
        <defs>
          ...
          <mask id="maskX" maskUnits="userSpaceOnUse">
            ...
            <motion.rect 
              ...
              fill="white"
              initial={{ x: -210 }}
              animate={isAnimating ? { x: 0 } : { x: -210 }}
              transition={{ duration: 3, ease: [0.55, 0.08, 0.44, 0.99] }}
            />
          </mask>
          ...
          <mask id="maskY" maskUnits="userSpaceOnUse">
            ...
            <motion.rect 
              ...
              fill="white"
              initial={{ y: -170 }}
              animate={isAnimating ? { y: 0 } : { y: -170 }}
              transition={{ duration: 3, ease: [0.55, 0.08, 0.44, 0.99], delay: 2.7 }}
            />
          </mask>
          ...
          <mask id="maskTop" maskUnits="userSpaceOnUse">
            ...
            <motion.rect 
              ...
              initial={{ x: -210 }}
              animate={isAnimating ? { x: 0 } : { x: -210 }}
              transition={{ duration: 1.5, ease: "easeInOut", delay: 5.8 }}
            />
          </mask>
          ...
          <mask id="maskRight" maskUnits="userSpaceOnUse">
            ...
            <motion.rect 
              ...
              initial={{ y: -170 }}
              animate={isAnimating ? { y: 0 } : { y: -170 }}
              transition={{ duration: 1.5, ease: "easeInOut", delay: 7.1 }}
            />
          </mask>
          ...
          <mask id="maskBottom" maskUnits="userSpaceOnUse">
            ...
            <motion.rect 
              ...
              initial={{ x: 210 }}
              animate={isAnimating ? { x: 0 } : { x: 210 }}
              transition={{ duration: 1.5, ease: "easeInOut", delay: 8.4 }}
            />
          </mask>
          ...
          <mask id="maskLeft" maskUnits="userSpaceOnUse">
            ...
            <motion.rect 
              ...
              initial={{ y: 170 }}
              animate={isAnimating ? { y: 0 } : { y: 170 }}
              transition={{ duration: 1.5, ease: "easeInOut", delay: 9.7 }}
            />
          </mask>
        </defs>
        ...
        {/* Capa 3: Marco negro */}
        <line className="stroke-black stroke-1" x1="22.3182" y1="51.9211" x2="185.0042" y2="51.9211" mask="url(#maskTop)" strokeLinecap="round" strokeLinejoin="round" fill="none" />
        <line className="stroke-black stroke-1" x1="173.3234" y1="36.2735" x2="173.778" y2="134.9636" mask="url(#maskRight)" strokeLinecap="round" strokeLinejoin="round" fill="none" />
        <line className="stroke-black stroke-1" x1="185.0042" y1="118.5687" x2="22.3182" y2="118.5687" mask="url(#maskBottom)" strokeLinecap="round" strokeLinejoin="round" fill="none" />
        <line className="stroke-black stroke-1" x1="40.4825" y1="30.2342" x2="40.4825" y2="137.8011" mask="url(#maskLeft)" strokeLinecap="round" strokeLinejoin="round" fill="none" />
        ...
        <motion.path 
          ...
          animate={isAnimating ? { strokeDashoffset: 0 } : { strokeDashoffset: 2000 }}
          transition={{ duration: 20, ease: "easeOut", delay: 11 }}
        />

        {/* Capa 5: G interior roja */}
        <motion.polyline 
          className="stroke-gd-red"
          strokeWidth="0.75"
          strokeLinecap="round"
          ...
          initial={{ strokeDasharray: "2000", strokeDashoffset: 2000 }}
          animate={isAnimating ? { strokeDashoffset: 0 } : { strokeDashoffset: 2000 }}
          transition={{ duration: 5, ease: "easeInOut", delay: 11 }}
        />

        {/* Capa 5: G exterior roja */}
        <motion.path 
          className="stroke-gd-red"
          strokeWidth="1"
          strokeLinecap="round"
          ...
          initial={{ strokeDasharray: "2000", strokeDashoffset: 2000 }}
          animate={isAnimating ? { strokeDashoffset: 0 } : { strokeDashoffset: 2000 }}
          transition={{ duration: 6, ease: "easeInOut", delay: 12 }}
        />
        ...
        <motion.path 
          ...
          animate={isAnimating ? { strokeDashoffset: 0 } : { strokeDashoffset: 3000 }}
          transition={{ duration: 6, ease: "easeInOut", delay: 15 }}
        />
      </motion.svg>
    </div>
  );
